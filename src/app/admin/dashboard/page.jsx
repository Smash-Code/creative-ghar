        ...
        <div className='col-span-12 lg:col-span-4 ' >
          <div className="flex flex-col mb-4 shadow-xl ">
            ...
            <div className="bg-white p-2 flex justify-between w-full  rounded-xl mt-8">
              <button aria-label='Stat' className="px-2 py-2 bg-yellow-100 text-yellow-800 rounded-lg font-semibold">
                Pending: {stats.totalPending}
              </button>
              <button aria-label='Stat' className="px-2 py-2 bg-blue-100 text-blue-800 rounded-lg font-semibold">
                Shipped: {stats.totalShipped}
              </button>
              <button aria-label='Stat' className="px-2 py-2 bg-green-100 text-green-800 rounded-lg font-semibold">
