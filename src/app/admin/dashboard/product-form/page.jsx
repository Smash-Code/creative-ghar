              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="md:col-span-2">
                    ...
                    {formData.images.length > 0 && formData.images.map((img, index) => (
                      ...
                      >
                        <img
                          ...
                          className={`w-24 h-24 object-cover rounded-md border ${draggedIndex === index ? 'opacity-50' : ''}`}
                        />
                        <div className="absolute top-1 left-1 bg-red-400/70 rounded-full px-[6px] text-white text-sm">
                          {index + 1}
                        </div>
                        <button
                          type="button"
                  ...
                  <p className="text-xs text-gray-500">
                    Upload up to {MAX_IMAGES} images (JPG, PNG up to 5MB each). Drag and drop to reorder.
                  </p>
                </div>
