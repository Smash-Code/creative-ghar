      ...
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full max-h-[90vh] overflow-y-auto">
        <div className="p-6">
          ...
          >
            ...
            {/* <div className="border-t border-gray-200 pt-4">
              <h3 className="font-medium mb-2">Customer Information</h3>
              <p className="text-sm">{orderDetails.customerInfo?.username}</p>
              <p className="text-sm">{orderDetails.customerInfo?.email}</p>
              <p className="text-sm">{orderDetails.customerInfo?.phone}</p>
              <p className="text-sm">{orderDetails.customerInfo?.address}, {orderDetails.customerInfo?.city}</p>
              <p className="text-sm">{orderDetails.customerInfo?.country}</p>
            </div> */}
