    ...
    return (
        <div className='relative' >
            <div className='min-h-[300px]' >
                <Image src='/newsletter-img.png' alt='Newsletter' height={300} width={1320} className='min-h-[300px] min-w-[1200px] object-center' />
            </div>
            <div className='absolute top-[15%] md:top-[30%] left-0 right-0 mx-auto flex flex-col items-center justify-center ' >
                <div className='text-2xl md:text-3xl font-bold text-black text-center ' >Subscribe To Our Newsletter</div>
