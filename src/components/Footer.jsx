...
const Footer = () => {
    return (
        <div className='max-w-[1320px] border-t-1 border-gray-100 mx-auto grid grid-cols-12 py-8 gap-10 px-4'>
            {/* Logo column - centered on small screens, normal on larger */}
            <div className='col-span-12 text-center md:text-left md:col-span-6 lg:col-span-3'>
                <Image
                    alt='logo'
